module QuestModule
  ...
  Quest12 = {
    ...
    Trashcan = {
    :ID => "13",
    :Name => "What's in your trashcan?",
    :QuestGiver => "The NES",
    :Stage1 => "Find the Trashcan.",
    :Location1 => "Somewhere in the house?",
    :QuestDescription => "There's something in your trashcan, but what is it?",
